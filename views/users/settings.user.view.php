        ...
        <div class="form-content">
            <form id="settings-user__form" method="post">
                ...
                <div class="input-group">
                    ...
                    <div class="avatar-image">
                        <label for="input-user-avatar">
                            ...
                            <div id="review-user-image" class="review-image review-avatar-image" data-target="input-user-avatar" title="Cập nhật ảnh mới">
                ...
                <div class="input-group">
                    ...
                    <label class="label-info" for="username">Thông tin định danh người dùng không thể thay đổi.</label>
                </div>
                <div class="input-group">
                ...
                <div class="input-group">
                    <label class="label-title" for="mail">Địa chỉ mail</label>
                    <input type="text" value="" name="mail" placeholder="Địa chỉ mail" id="mail" autofocus>
